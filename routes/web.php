...
Route::group(['prefix'=>'admin'],function(){
    ...
    Route::group(['prefix'=>'payment-gateway-settings'],function() {
        Route::get('/', [PaymentGatewayController::class, 'index'])->name('admin.paymentSettings');
        Route::get('/edit', [PaymentGatewayController::class, 'edit'])->name('admin.paymentSettings.edit');
